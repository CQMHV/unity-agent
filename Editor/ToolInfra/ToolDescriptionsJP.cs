...
namespace AjisaiFlow.UnityAgent.Editor
{
    ...
    internal static class ToolDescriptionsJP
    {
        ...
        private static readonly Dictionary<string, string> ManualOverrides = new Dictionary<string, string>
        {
            ...
            { "RemoveAnimatorLayer", "Animatorレイヤーを削除" },
            { "RemoveAnimatorParameter", "Animatorパラメータを削除" },
            { "MoveAnimatorLayer", "Animatorレイヤーの順序変更" },
            { "RenameAnimatorLayer", "Animatorレイヤー名を変更" },
            { "RenameAnimatorState", "Animatorステート名を変更" },
            { "RenameAnimatorParameter", "Animatorパラメータ名を変更" },
            { "SetAnimatorParameterDefault", "Animatorパラメータのデフォルト値を変更" },
            { "DuplicateAnimatorState", "Animatorステートを複製" },
            { "CreateBlendTree", "BlendTreeを作成" },
            { "BatchSetWriteDefaults", "Write Defaultsを一括設定" },

            // ── VRChat Core ──
            { "InspectVRCAvatarDescriptor", "VRCアバターの設定を表示" },
            { "GetAvatarPerformanceStats", "パフォーマンスランクを確認" },
            { "ListVRCExpressionParameters", "ExpressionParameterの一覧" },
            { "AddVRCExpressionParameter", "ExpressionParameterを追加" },
            { "RemoveVRCExpressionParameter", "ExpressionParameterを削除" },
            { "InspectVRCExpressionsMenu", "Expressionメニューの内容を表示" },
            { "AddVRCExpressionsMenuToggle", "メニューにトグルを追加" },
            { "AddVRCExpressionsMenuButton", "メニューにボタンを追加" },
            { "AddVRCExpressionsMenuSubMenu", "サブメニューを追加" },
            { "AddVRCExpressionsMenuRadialPuppet", "ラジアルパペットを追加" },
            { "RemoveVRCExpressionsMenuControl", "メニューコントロールを削除" },
            { "SetupObjectToggle", "オブジェクトトグルを一括セットアップ" },
            { "CreateToggleAnimations", "ON/OFFアニメーションを生成" },
            { "GetVRCFXControllerPath", "FXコントローラーのパスを取得" },
            ...
            // ── NDMF (nadena.dev.ndmf 本体) ──
            { "GetNDMFInfo", "NDMFのバージョン・検出状況を取得" },
